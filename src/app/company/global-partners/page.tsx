...
// 파트너사 정보를 배열로 관리합니다. (데이터와 뷰의 분리)
    ...
    const partnerLinks = {
        ...
        "Schneider-Kreuznach": "https://schneiderkreuznach.com/en",
        "DZOPTICS": "https://www.dzoptics.com/",
        "NEW TRY": "https://www.new-try.com/",
        "ICORE": "https://icorecorp.com/?locale=ko_KR",
        "PlusTek": "http://www.plus-tek.co.kr",
        "LVS CO.,Ltd": "http://www.lvs.co.kr/",
        "LR-LINK": "https://www.lr-link.com/",
        "Alysium Tech GmbH": "https://www.alysium.com/"
    };
...
const partners: Partner[] = [
  {
    ...
    link: partnerLinks["Teleyne Dalsa"],
  },
  {
    ...
    link: partnerLinks["Teledyne FLIR"],
  },
  {
  ...
  },
  {
    ...
    link: partnerLinks["Teledyne Photometrics"],
  },
  {
    ...
    link: partnerLinks["Teledyne Princeton Instruments"],
  },
  {
    ...
    link: partnerLinks["Teledyne Lumenera"],
  },
  {
    ...
    link: partnerLinks["DAHENG IMAGING"],
  },
  {
    ...
    link: partnerLinks["Schneider-Kreuznach"],
  },
  {
  ...
  },
  {
    ...
    link: partnerLinks["Alysium Tech GmbH"],
  },
];
          ...
          {partners.map((partner) => (
            partner.link ? (
              <a 
                ...
                className={`${styles['global-partners-item']} ${styles['flex-col']}`}
              >
