    ...
    filters: [
      {
        ...
        options: [
          ...
          { display: "100mm ~ 499mm", value: "BETWEEN 100 AND 499" },
      ...
      },
      {
        ...
        options: [
          ...
          { display: "ETC", value: "NOT IN ('Mono','Color')" }
        ]
      },
      {
        name: "Interface",
        ...
        options: [
          ...
          { display: "ETC", value: "NOT IN ('CoaXPress','Camera Link','40GigE','10GigE','1GigE')" }
        ]
      },
      {
        name: "Maker",
        ...
        options: [
          ...
          { display: "ETC", value: "NOT IN ('INSNEX','ARES INTELTECH')" }
        ]
      }
    ]
  },
